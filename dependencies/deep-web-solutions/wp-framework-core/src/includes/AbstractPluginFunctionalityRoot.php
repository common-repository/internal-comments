...
namespace DWS_IC_Deps\DeepWebSolutions\Framework\Core;

use DWS_IC_Deps\DeepWebSolutions\Framework\Core\Actions\Installable\InstallFailureException;
use DWS_IC_Deps\DeepWebSolutions\Framework\Core\Actions\Installable\UninstallFailureException;
use DWS_IC_Deps\DeepWebSolutions\Framework\Core\Functionalities\InstallationFunctionality;
use DWS_IC_Deps\DeepWebSolutions\Framework\Core\Functionalities\InternationalizationFunctionality;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Actions\Initializable\InitializableTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Actions\Initializable\InitializationFailureException;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Actions\Initializable\Integrations\MaybeSetupOnInitializationTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Actions\Setupable\Integrations\RunnablesOnSetupTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Actions\SetupableInterface;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\DependencyInjection\ContainerAwareInterface;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\DependencyInjection\ContainerAwareTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Hierarchy\Actions\AddContainerChildrenTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Hierarchy\Actions\InitializeChildrenTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Hierarchy\Actions\MaybeSetupChildrenTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Hierarchy\Plugin\AbstractPluginRoot;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\Logging\LoggingService;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\States\Activeable\ActiveableTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\States\ActiveableInterface;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\States\Disableable\DisableableTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Foundations\States\DisableableInterface;
use DWS_IC_Deps\DeepWebSolutions\Framework\Helpers\FileSystem\Files;
use DWS_IC_Deps\DeepWebSolutions\Framework\Helpers\HooksHelpersAwareInterface;
...
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\Hooks\HooksServiceRegisterInterface;
use DWS_IC_Deps\Psr\Container\ContainerInterface;
use function DWS_IC_Deps\DeepWebSolutions\Framework\dws_wp_framework_get_core_init_status;
use function DWS_IC_Deps\DeepWebSolutions\Framework\dws_wp_framework_output_initialization_error;
