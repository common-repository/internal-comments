...
namespace DWS_IC_Deps\DeepWebSolutions\Framework\Core\Functionalities;
...
use DWS_IC_Deps\DeepWebSolutions\Framework\Core\Actions\InstallableInterface;
...
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\Actions\InitializeAdminNoticesServiceTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\Actions\SetupAdminNoticesTrait;
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\AdminNoticesService;
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\AdminNoticesServiceAwareInterface;
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\AdminNoticesServiceRegisterInterface;
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\AdminNoticeTypesEnum;
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\Helpers\AdminNoticesServiceHelpers;
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\Notices\DismissibleAdminNotice;
use DWS_IC_Deps\DeepWebSolutions\Framework\Utilities\AdminNotices\Notices\SimpleAdminNotice;
...
use function DWS_IC_Deps\DeepWebSolutions\Framework\dws_wp_framework_get_core_base_path;
...
class InstallationFunctionality extends AbstractPluginFunctionality implements AdminNoticesServiceAwareInterface, AdminNoticesServiceRegisterInterface, HooksServiceRegisterInterface {
	...
	public function output_installation_js() {
		...
		$js_script = Strings::replace_placeholders(
			...
			array(
				...
				'%disabled_message%' => \esc_html__( 'Please wait...', 'internal-comments' ),
				...
				$this->get_admin_notices_service()->add_notice(
					new DismissibleAdminNotice(
						...
						/* translators: 1. Installation node name, 2. Error message. */
							__( '<strong>%1$s</strong> failed to complete the installation routine. The error is: %2$s', 'internal-comments' ),
	...
	public function install_or_update() : ?InstallFailureException {
		...
		$message = \is_null( $result ) ? __( '<strong>%1$s</strong> was successfully updated.', 'internal-comments' ) : __( '<strong>%1$s</strong> was successfully installed.', 'internal-comments' );
