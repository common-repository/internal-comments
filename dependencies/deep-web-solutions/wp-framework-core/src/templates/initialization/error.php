...
use function DWS_IC_Deps\DeepWebSolutions\Framework\dws_wp_framework_get_whitelabel_support_email;
use function DWS_IC_Deps\DeepWebSolutions\Framework\dws_wp_framework_get_whitelabel_support_url;
	...
	<p>
		...
		echo wp_kses_post(
			...
			/* translators: 1. Plugin name, 2. Plugin version, 3. Support email, 4. Support website */
				__( '<strong>%1$s (v%2$s)</strong> initialization failed. Please contact us at <strong><a href="mailto:%3$s">%3$s</a></strong> or visit our <strong><a href="%4$s" target="_blank">support website</a></strong> to get help. Please include this error notice in your support query:', 'internal-comments' ),
