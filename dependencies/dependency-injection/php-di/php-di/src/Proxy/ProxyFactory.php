...
namespace DWS_IC_Deps\DI\Proxy;

use DWS_IC_Deps\ProxyManager\Configuration;
use DWS_IC_Deps\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use DWS_IC_Deps\ProxyManager\FileLocator\FileLocator;
use DWS_IC_Deps\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use DWS_IC_Deps\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
