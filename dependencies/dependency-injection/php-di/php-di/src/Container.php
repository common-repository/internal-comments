...
use DWS_IC_Deps\DI\Definition\Definition;
use DWS_IC_Deps\DI\Definition\Exception\InvalidDefinition;
use DWS_IC_Deps\DI\Definition\FactoryDefinition;
use DWS_IC_Deps\DI\Definition\Helper\DefinitionHelper;
use DWS_IC_Deps\DI\Definition\InstanceDefinition;
use DWS_IC_Deps\DI\Definition\ObjectDefinition;
use DWS_IC_Deps\DI\Definition\Resolver\DefinitionResolver;
use DWS_IC_Deps\DI\Definition\Resolver\ResolverDispatcher;
use DWS_IC_Deps\DI\Definition\Source\DefinitionArray;
use DWS_IC_Deps\DI\Definition\Source\MutableDefinitionSource;
use DWS_IC_Deps\DI\Definition\Source\ReflectionBasedAutowiring;
use DWS_IC_Deps\DI\Definition\Source\SourceChain;
use DWS_IC_Deps\DI\Definition\ValueDefinition;
use DWS_IC_Deps\DI\Invoker\DefinitionParameterResolver;
use DWS_IC_Deps\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use DWS_IC_Deps\Invoker\Invoker;
use DWS_IC_Deps\Invoker\InvokerInterface;
use DWS_IC_Deps\Invoker\ParameterResolver\AssociativeArrayResolver;
use DWS_IC_Deps\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use DWS_IC_Deps\Invoker\ParameterResolver\DefaultValueResolver;
use DWS_IC_Deps\Invoker\ParameterResolver\NumericArrayResolver;
use DWS_IC_Deps\Invoker\ParameterResolver\ResolverChain;
