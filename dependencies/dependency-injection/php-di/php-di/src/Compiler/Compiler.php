...
namespace DWS_IC_Deps\DI\Compiler;

use function chmod;
use DWS_IC_Deps\DI\Definition\ArrayDefinition;
use DWS_IC_Deps\DI\Definition\DecoratorDefinition;
...
use DWS_IC_Deps\DI\Definition\Source\DefinitionSource;
use DWS_IC_Deps\DI\Definition\StringDefinition;
use DWS_IC_Deps\DI\Definition\ValueDefinition;
use DWS_IC_Deps\DI\DependencyException;
use DWS_IC_Deps\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use DWS_IC_Deps\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
